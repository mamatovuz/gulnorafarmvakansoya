...
- **📝 Ishga ariza topshirish** — 20 savoldan iborat to'liq anketa:
  ...
  oldingi/kutilayotgan maosh, Word/Excel darajasi, tillar, ishlash niyati, sabab,
  telefon (contact), rezyume/diplom (fayl yoki o'tkazib yuborish)
...
- Savollar: ism-familiya, tug'ilgan sana, **yo'nalish (rol)**, manzil, **filial** (admin ro'yxatidan),
  ish vaqti (dan-gacha), oylik, dam olish kuni, forma bor/yo'q, **oxirgi 10 kundagi rasm**
- Rolga qarab qo'shimcha savollar: filial rahbari/direktor uchun staj va boshqaruv hajmi
